                ...
                <div class="card shadow mb-4">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" v-model="product.title" placeholder="Product Title" class="form-control">
                            <template v-if="errors.title">
                                <p class="text-danger mt-1" v-for="(error, index) in errors.title" :key="index">
                                    {{ error }}
                                </p>
                            </template>
                        </div>
                        <div class="form-group">
                            ...
                            <template v-if="errors.sku">
                                <p class="text-danger mt-1" v-for="(error, index) in errors.sku" :key="index">
                                    {{ error }}
                                </p>
                            </template>
                        </div>
                        <div class="form-group">
                            ...
                            <textarea v-model="product.description" id="" cols="30" rows="4"
                                class="form-control"></textarea>
                            <template v-if="errors.description">
                                <p class="text-danger mt-1" v-for="(error, index) in errors.description" :key="index">
                                    {{ error }}
                                </p>
                            </template>
                        </div>
